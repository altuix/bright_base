      ...
      const mockRows: ContentRow[] = [
        {
          ...
          items: Array(10)
            ...
            .map((_, i) => ({
              ...
              imageUrl: `https://via.placeholder.com/400x225?text=Trending+${
                i + 1
              }`,
        ...
        },
        {
          ...
          items: Array(10)
            ...
            .map((_, i) => ({
              ...
              imageUrl: `https://via.placeholder.com/400x225?text=Recommended+${
                i + 1
              }`,
        ...
        },
        {
          ...
          items: Array(10)
            ...
            .map((_, i) => ({
              ...
              imageUrl: `https://via.placeholder.com/400x225?text=Live+${
                i + 1
              }`,
              type: "live",
            })),
          ...
          foundContent.type === "series"
            ? Array(8)
                ...
                .map((_, i) => ({
                  ...
                  thumbnail: `https://via.placeholder.com/400x225?text=Episode+${
                    i + 1
                  }`,
                }))
            : undefined,
